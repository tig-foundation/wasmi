...
impl StoreInner {
    ...
    pub fn update_runtime_signature(&mut self, value: u64) {
        self.runtime_signature ^= value;
        self.runtime_signature ^= self.runtime_signature >> 27;
        self.runtime_signature ^= self.runtime_signature << 23;
        self.runtime_signature = self.runtime_signature.wrapping_mul(0xdfd951778ea84a0f);
    }
}
